...
require("./update.php");
session_start();
if ($_SESSION['email'] == '' && $fetch2['usertype'] != 'Admin') {
                         ...
                         src="data:image/jpeg;base64,' . base64_encode($fetch2[0]['image']) .  '">  </img>'; ?>
                                ...
                                <div class="user-info"><br>
                                    <p style="text-align: center;"> <span
                                        ...
                                        <?php if ($fetch2[0]['usertype'] == 'Admin') : ?>
                            ...
                            <button><a href="./user.php">User Page</a></button>
                        ...
                        <div class="card phonearr rounded-0 p-0 shadow-sm">
                         ...
                         src="data:image/jpeg;base64,' . base64_encode($phone['ph_photo']) .  '">  </img>'; ?>
                            ...
                            <div class="card-body text-center">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <!-- Modal -->
                                        <div class="modal fade" id="_<?php echo  $phone['id'] ?>" tabindex="-1"
                                                        ...
                                                        <form action="update.php" method="POST">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input name="brand" type="text" class="form-control"
                                                                    value="<?php echo  $phone['brand'] ?>"
                                                                    placeholder="Brand">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Phone Description</label>
                                                                <input name="ph_description" type="text"
                                                                    class="form-control"
                                                                    value="<?php echo $phone['ph_description'] ?>"
                                                                    placeholder="Description">
                                                            </div>

                                                            <div class="form-group">
                                                                <label>Network Technologies</label>
                                                                <input name="network_tech" type="text"
                                                                    class="form-control"
                                                                    value="<?php echo  $phone['network_tech'] ?>"
                                                                    placeholder="NetworkTech">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Network 2g</label>
                                                                <input name="network_2g" type="text"
                                                                    class="form-control"
                                                                    value="<?php echo  $phone['network_2g'] ?>"
                                                                    placeholder="network_2g">
                                                            </div>

                                                            <div class="form-group">
                                                                <label>Network 3g</label>
                                                                <input name="network_3g" type="text"
                                                                    class="form-control"
                                                                    value="<?php echo  $phone['network_3g'] ?>"
                                                                    placeholder="network_3g">
                                                            </div>

                                                            <div class="form-group">
                                                                <label>Network 4g</label>
                                                                <input name="network_4g" type="text"
                                                                    class="form-control"
                                                                    value="<?php echo  $phone['network_4g'] ?>"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input name="ph_quantity" type="number"
                                                                    value="<?php echo  $phone['ph_quantity'] ?>"
                         ...
                         src="data:image/jpeg;base64,' . base64_encode($phone['ph_photo']) .  '">  </img>'; ?>
                                        ...
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#_<?php echo $phone['id'] ?>">
                                            Edit Data
                                        </button>
                                    </div>
                                </div>
                                        ...
                                        <form action="addphones.php" method="post">
                                            ...
                                            <div>
                                                ...
                                                <input type="number" name="quantity"
                                                    value="<?php echo $phone['ph_quantity'] ?>" class="form-control" />

                                            </div> <br> <br>

                                            <textarea name="id" id="id" hidden><?php echo $phone['id'] ?></textarea>
                                            <button type="submit" class='btn btn-outline-success '
                                                name="btnId add_to_cart" data-id="">Add</button>
                                        </form>
                                    </div><br>
                                    <div class="col">
