    ...
    <form method="post" action="register.php">
        ...
        <div>
            ...
            <div>
                ...
                <input type="text" id="name" name="name" value="<?php echo $username; ?>" placeholder="Your Name">
            ...
            <div>
                ...
                <input type="password" name="pass" value="<?php echo $email; ?>" id="pass" placeholder="Your Password">
            </div>
